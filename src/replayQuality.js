export const REPLAY_QUALITY = {
  ...
  "2026-07-22": { level: "GREEN", label: "REPLAY READY · 20-SECOND VERIFIED CORE", summary: "1,216 playback ticks; native 20-second source; 31 of 31 validation checks passed; 0 missing GEX ticks.", missingEssential: [], benchmarkEligible: true },
};

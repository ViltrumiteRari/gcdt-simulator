...
assert.match(app, /OPTION_B_PRIMARY_ALIGNMENT/);
assert.match(app, /alignedPrimaryCount>=2\|\|strongPathOverride/);
assert.match(app, /setupQuality>=90/);
assert.match(app, /move15/);
assert.match(app, /move30/);
assert.match(app, /sustainedDirectionalMove>=0\.70/);
